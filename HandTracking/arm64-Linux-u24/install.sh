...
echo -e "\n1. Installing pip packages 'opencv-python' 'numpy', 'mediapipe'..."
...
echo -e "\n2. Installing apt packages 'build-essential', 'libopencv-dev', 'libgtk-3-dev', 'libboost-all-dev', 'nlohmann-json3-dev', 'python3-dev', 'pkg-config', 'python3-tk'..."
sudo apt install build-essential libopencv-dev libgtk-3-dev libboost-all-dev nlohmann-json3-dev python3-dev pkg-config python3-tk -y
if [[ $? -ne 0 ]]; then
